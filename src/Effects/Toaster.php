...
/*
convert test.jpg \( -clone 0 -fill '#330000' -colorize 100% \) \( -clone 0 
-colorspace gray -negate \) -compose blend -define compose:args=100,0 -composite test.jpg

convert test.jpg -modulate 150,80,100 -gamma 1.2 -contrast -contrast test.jpg

convert test.jpg \( -size 960.0x960.0 radial-gradient:none-LavenderBlush3 -gravity 
center -crop 640x640+0+0 +repage \) -compose multiply -flatten test.jpg

convert test.jpg \( -size 960.0x960.0 radial-gradient:#ff9966-none -gravity center 
-crop 640x640+0+0 +repage \) -compose multiply -flatten test.jpg
